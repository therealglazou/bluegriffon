  ...
  function CodeMirror(place, givenOptions) {
    ...
    var instance = wrapper.CodeMirror = {
      ...
      setOption: function(option, value) {
        ...
        if (option == "lineNumbers" || option == "gutter" || option == "firstLineNumber" || option == "theme" || option == "extraGutterSize")
    ...
    function updateGutter() {
      ...
      doc.iter(showingFrom, Math.max(showingTo, showingFrom + 1), function(line) {
        if (line.hidden) {
          ...
          if (marker && marker.text)
            ...
            text = "\u00a0";
          html.push((marker && marker.style ? '<pre class="' + marker.style
                                              + '">'
                                            : "<pre>"), text);
      ...
      while (val.length + pad.length < minwidth + options.extraGutterSize) pad += "\u00a0";
